            ...
            <div style="padding: 16px; background-color: #fff;">
                ...
                <div class="mt-4 border border-gray-200 rounded-lg text-sm">
                    <div class="grid grid-cols-6 bg-gray-100 rounded-t-lg">
                        <div
                            class="col-span-2 text-left text-xs font-medium text-gray-800 px-4 py-2 border-r border-gray-200">
                            Option</div>
                ...
                <div class="mt-4 border border-gray-200 rounded-lg text-sm">
                    ...
                    <div class="grid grid-cols-5">
                        <div
                            class="col-span-3 text-left text-xs font-medium text-gray-800 px-4 py-2 border-r border-gray-200">
