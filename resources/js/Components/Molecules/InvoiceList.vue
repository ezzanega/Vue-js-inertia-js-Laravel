<template>
    <div class="overflow-hidden space-y-2">
      <SearchBar
        ...
        placeholder="Recherchez un numéro de document"
      />
      <div
      ...
      >
        ...
        <div class="w-3/12">N° Facture</div>
        <div class="w-3/12">Date de déménagement</div>
        <div class="w-2/12">Statut</div>
        <div class="w-2/12">Montant HT</div>
        <div class="w-2/12">Montant TTC</div>
        <div class="w-1/12"></div>
      </div>
      
      <InvoiceListItem
        v-for="(document, index) in $page.props.invoices"
        :key="index"
        :document="document"
      />
    </div>
