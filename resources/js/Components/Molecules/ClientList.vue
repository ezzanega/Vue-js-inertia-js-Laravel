<template>
  <div class="overflow-hidden space-y-2">
    <div class="flex flex-row justify-between items-center mt-5">
      <SearchBar name="client" class="shrink mt-1 mx-1 w-1/3" v-model="searchQuery" placeholder="Recherchez un nom de client" />
    ...
    <div
      ...
      <div class="w-1/12"><input name="" type="checkbox"
            class="form-checkbox rounded-md text-primary h-5 w-5 focus:ring-0" :checked="selectedAll" @change="toggleSelectedAll"/></div>
      <div class="w-2/12 text-center flex flex-row justify-center items-center">Nom
      ...
      <div class="w-2/12 text-center flex flex-row justify-center items-center">Type de client
        <div class="flex flex-col items-center ml-2">
            <button>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                class="w-3 h-3 text-gray-400 hover:text-gray-900"
      ...
      <div class="w-2/12 text-center flex flex-row justify-center items-center">Email
        <div class="flex flex-col items-center ml-2">
            <button>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                class="w-3 h-3 text-gray-400 hover:text-gray-900"
      ...
      <div class="w-2/12 text-center flex flex-row justify-center items-center">Télephone
        <div class="flex flex-col items-center ml-2">
            <button>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                class="w-3 h-3 text-gray-400 hover:text-gray-900"
      ...
      <div class="w-2/12 text-center flex flex-row justify-center items-center">Source
        <div class="flex flex-col items-center ml-2">
            <button>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                class="w-3 h-3 text-gray-400 hover:text-gray-900"
    ...
    <div v-if="!$page.props.clients.length" class="w-full text-center text-lg py-2">
