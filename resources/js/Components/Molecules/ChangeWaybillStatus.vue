                ...
                <div class="flex items-start justify-between">
                    <div class="space-y-1">
                        <h2 id="headlessui-dialog-title-15" data-headlessui-state="open" class="text-lg font-medium">
                            Changer le statut de lettre de voiture
                        </h2>
                    </div>
            ...
            <div class="px-4 sm:px-6">
                <div class="w-full py-3 flex flex-col space-y-2">
                    <div class="my-6 space-y-5">
                        <DefaultSelectInput name="status" label="Statuts" v-model="form.status" :options="waybillStatus"
...
const updateStatus = () => {
    //alert('waybill status changé');
    form.put(route("6dem.waybill.updateStatus", { id: props.waybill.id, field: "status" }), {
        preserveScroll: true,
        preserveState: true,
        replace: true,
        onSuccess: () => {
