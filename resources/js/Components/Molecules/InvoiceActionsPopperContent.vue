<template>
  <div class="w-auto">
    <div class="space-y-0.5">
      ...
      <PopperItem item="Modifier"  @clicked="openUpdateModal(document)">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
          class="mr-2 h-5 w-5 shrink-0 text-neutral-500 group-hover:text-neutral-600">
          <path stroke-linecap="round" stroke-linejoin="round"
      ...
      <PopperItem item="Supprimer la facture" @clicked="opendelModal(document.id,'facture')">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
          class="mr-2 h-5 w-5 shrink-0 text-neutral-500 group-hover:text-neutral-600">
          <path stroke-linecap="round" stroke-linejoin="round"
...
const props = defineProps({
  ...
  client_id: {
    ...
    //Props pour la suppression de Facture
    document: {
    type: Object,
    required: true,
  },
...
const sendToClient = () => {
    router.visit(route("6dem.documents.send.invoice", [props.document.id]), {
      method: "get",
    });
  };
</script>
