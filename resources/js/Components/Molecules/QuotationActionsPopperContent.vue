<template>
  <div class="w-auto">
    <div class="space-y-0.5">
      ...
      <PopperItem item="Changer le statut du devis" @clicked="updateQuotationStatus">
      ...
      <PopperItem v-if="client.type === 'individual'" item="Dupliquer dans une autre formule" @clicked="openDupQuotModal(quotation.id)">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 h-5 w-5 shrink-0 text-neutral-500 group-hover:text-neutral-600">
      ...
      <PopperItem
        item="Générer la lettre de voiture"
        @clicked="PopperItemClicked"
      >
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
          stroke-width="1.5" stroke="currentColor" class="mr-2 h-5 w-5 shrink-0 text-neutral-500 group-hover:text-neutral-600">
...
const createInvoice = () => {
  router.visit(
    route("6dem.documents.invoice.init", props.quotation.id),{
      method: "post",
  });
};
