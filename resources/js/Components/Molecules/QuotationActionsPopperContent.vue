<template>
  <div class="w-auto">
    <div class="space-y-0.5">
      ...
      <PopperItem v-if="props.document.moving_job.client.type == 'individual'" item="Dupliquer dans une autre formule" @clicked="PopperItemClicked"
      >
      ...
      <PopperItem item="Créer une facture pour ce devis" @clicked="createInvoice"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
