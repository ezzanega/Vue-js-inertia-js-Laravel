        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            ...
            <div class="mt-5 md:col-span-2 md:mt-0 flex flex-col space-y-3">
                <div class="p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6">
                    <div v-if="executingCompanies"  class="space-x-2 xl:flex">
                        <div class="w-auto xl:w-1/2">
                            <ul class="my-4 space-y-3">
                                <li v-for="(executingCompany, index) in executingCompanies" :key="index">
                                    <a href="#"
                    ...
                    <div v-else><p class="text-sm font-normal text-gray-500">Vous n'avez encore aucun prestataire. Rajoutez-en un dès à présent.</p></div>
                </div>
            </div>
        </div>
    </div>
