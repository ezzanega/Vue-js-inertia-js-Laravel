    ...
    <div class="flex flex-col space-y-5 px-10 mt-16">
      ...
      <div class="grid grid-cols-2 gap-20 justify-between">
        <div class="flex flex-col space-y-2">
          ...
          <DocumentFieldFrame>
            <DocumentFieldInput v-model="movingjob.loading_address" placeholder="Adresse de chargement"
              :modelValue="currentMovingJob.loading_address" :fontBold="true"
              @savingValue="saveField('loading_address')" />
          </DocumentFieldFrame>
        ...
        <div class="flex flex-col space-y-2">
          ...
          <DocumentFieldFrame>
            <DocumentFieldInput placeholder="Adresse de livraison" v-model="movingjob.shipping_address"
              :modelValue="currentMovingJob.shipping_address" :fontBold="true"
