    ...
    <div class="overflow-hidden space-y-2">
        <div class="flex flex-row items-center justify-between mt-5">
            <div class="flex flex-row space-x-2 items-center">
                <IconButton class="mt-6" text="Ajouter un paiement" >
        ...
        <div
            ...
            <div class="flex flex-row items-center justify-center w-2/12 text-center">Payment channel
            </div>
            <div class="flex flex-row items-center justify-center w-2/12 text-center">Montant HT
            </div>
