        ...
        <div class="flex flex-1 justify-between pr-4 sm:pr-6 lg:pr-8">
          <div class="w-full flex justify-between">
            ...
            <div class="mx-5 hidden lg:flex items-center">
              <SecondaryButton @click="downloadWaybill">
                ...
                <template #popper>
                  <div class="w-auto">
                    <div class="space-y-0.5">
                      <PopperItem item="Télécharger" @clicked="downloadWaybill">
                      ...
                      <PopperItem item="Envoyer au client" @clicked="">
...
const sendToClient = () => {
  router.visit(route("6dem.documents.send.waybill", [waybill.id]), {
    method: "get",
  });
};

const updateQuotation = () => {
  router.visit(route("6dem.documents.quotation", [waybill.moving_job.id, waybill.moving_job.client.id, waybill.quotation_id]), {
    method: "get",
  });
};
</script>