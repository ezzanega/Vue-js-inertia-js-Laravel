<template>
  ...
  <DemLayout>
    <div class="mb-4 text-sm text-gray-600">
      <ListEmptyMessage message-title="Vous n'avez pas de documents créés"
        message-content="Commencez par ajouter un nouveau document">
        <IconButton class="mt-6" text="Créer un document" @click="toggleDrawer">
    ...
    <Drawer :is-open="isDrawerOpen" :speed="500" :max-width="innerWidth" @close="closeDrawer">
      <div>
        <DrawerContent title="Choix du document" @closeDrawer="closeDrawer()">
          <SelectClientModal @choosingClient="closeDrawer" />
          <IconButton class="mt-6" text="Facture client" />
          <IconButton class="mt-6" text="Lettre de voiture" />
        </DrawerContent>
      </div>
    </Drawer>
  </DemLayout>
